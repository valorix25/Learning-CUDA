...
inline char *sdkFindFilePath(const char *filename,
  ...
  const char *searchPath[] = {
      ...
      "./7_MACALibraries/",             // "/7_MACALibraries/" subdir
      ...
      "./6_Advanced/<executable_name>/data/",  // "/6_Advanced/<executable_name>/data/"
                                               // subdir
      "./7_MACALibraries/<executable_name>/",  // "/7_MACALibraries/<executable_name>/"
                                               // subdir
      "./7_MACALibraries/<executable_name>/data/",  // "/7_MACALibraries/<executable_name>/data/"
                                                    // subdir
      ...
      "../6_Advanced/<executable_name>/data/",  // up 1 in tree,
                                                ...
                                                // subdir
      "../7_MACALibraries/<executable_name>/data/",  // up 1 in tree,
                                                     // "/7_MACALibraries/<executable_name>/"
                                                     // subdir
      ...
      "../../6_Advanced/<executable_name>/data/",  // up 2 in tree,
                                                   // "/6_Advanced/<executable_name>/"
                                                   // subdir
      "../../7_MACALibraries/<executable_name>/data/",  // up 2 in tree,
                                                        // "/7_MACALibraries/<executable_name>/"
                                                        // subdir
      ...
      "../../../6_Advanced/<executable_name>/data/",  // up 3 in tree,
                                                      // "/6_Advanced/<executable_name>/"
                                                      // subdir
      "../../../7_MACALibraries/<executable_name>/data/",  // up 3 in tree,
                                                           // "/7_MACALibraries/<executable_name>/"
                                                           // subdir
      ...
      "../../../6_Advanced/<executable_name>/",  // up 3 in tree,
                                                 // "/6_Advanced/<executable_name>/"
                                                 // subdir
      "../../../7_MACALibraries/<executable_name>/",  // up 3 in tree,
                                                      // "/7_MACALibraries/<executable_name>/"
                                                      // subdir
      ...
      "../../../../6_Advanced/<executable_name>/data/",  // up 4 in tree,
                                                         // "/6_Advanced/<executable_name>/"
                                                         // subdir
      "../../../../7_MACALibraries/<executable_name>/data/",  // up 4 in tree,
                                                              // "/7_MACALibraries/<executable_name>/"
                                                              // subdir
      ...
      "../../../../6_Advanced/<executable_name>/",  // up 4 in tree,
                                                    // "/6_Advanced/<executable_name>/"
                                                    // subdir
      "../../../../7_MACALibraries/<executable_name>/",  // up 4 in tree,
                                                         // "/7_MACALibraries/<executable_name>/"
                                                         // subdir
      ...
      "../../../../../6_Advanced/<executable_name>/data/",  // up 5 in tree,
                                                            // "/6_Advanced/<executable_name>/"
                                                            // subdir
      "../../../../../7_MACALibraries/<executable_name>/data/",  // up 5 in
                                                                 // tree,
                                                                 // "/7_MACALibraries/<executable_name>/"
                                                                 // subdir
